  ...
  return (
    <Fragment>
      <div className='flex flex-row  place-content-between pt-6 lg:place-content-start lg:gap-y-8 lg:pt-0'>
        <PopoverButton
          buttonText="Damage"
          overrideButtonClassname="h-full w-full bg-[rgb(231,22,15)] text-white"
          overridePopoverClassname="h-[60px] w-[33%] lg:ml-4 lg:w-32"
          overridePanelClassname="flex flex-col gap-y-2 rounded-lg border-2 bg-slate-100 p-4 shadow-2xl"
          placement="top-end"
        >
        ...
        <PopoverButton
          buttonText="Heal"
          overrideButtonClassname="h-full w-full bg-[rgb(32,150,243)] text-white"
          overridePopoverClassname="h-[60px] w-[33%] lg:ml-4 lg:w-32"
          overridePanelClassname="flex flex-col gap-y-2 rounded-lg border-2 bg-slate-100 p-4 shadow-2xl"
          placement="top-start"
        >
